  ...
  return (
    <div className="bg-rose-50 min-h-screen py-12">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold font-serif mb-8 text-center text-rose-700">Sweet Checkout</h2>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-white p-8 rounded-xl shadow-lg border border-rose-100">
            <h3 className="text-2xl font-bold font-serif mb-6 text-rose-700">Delivery Details</h3>
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                <label htmlFor="address" className="block text-rose-700 font-medium mb-2">Delivery Address</label>
                <input type="text" id="address" name="address" value={customer.address} onChange={handleChange} required className="w-full px-4 py-2 border border-rose-200 rounded-md focus:ring-2 focus:ring-rose-400 focus:outline-none" />
              </div>
              <div className="mb-6">
                <label htmlFor="phone" className="block text-rose-700 font-medium mb-2">Phone Number</label>
                <input type="tel" id="phone" name="phone" value={customer.phone} onChange={handleChange} required className="w-full px-4 py-2 border border-rose-200 rounded-md focus:ring-2 focus:ring-rose-400 focus:outline-none" />
              </div>
              ...
              <div className="bg-rose-50 p-4 rounded-md border border-rose-100">
                <p className="font-semibold text-rose-700">Cash on Delivery</p>
                <p className="text-sm text-rose-700/80">Pay with cash when your desserts are delivered.</p>
              </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg h-fit border border-rose-100">
            <h3 className="text-2xl font-bold font-serif mb-6 text-rose-700">Dessert Summary</h3>
            {cartItems.map(item => (
